...
LIGHT_THEME="catppuccin-latte-mauve-standard+default"
DARK_THEME="catppuccin-mocha-mauve-standard+default"

LIGHT_QT="catppuccin-latte-mauve-standard+default"
DARK_QT="catppuccin-mocha-mauve-standard+default"
...
if [[ "$current" == "light" ]]; then
  ...
  sed -i 's/^gtk-theme-name=.*/gtk-theme-name=catppuccin-mocha-mauve-standard+default/' ~/.config/gtk-4.0/settings.ini
  ...
  export GTK_THEME="catppuccin-latte-mauve-standard+default"
  sed -i 's/^gtk-theme-name=.*/gtk-theme-name=catppuccin-latte-mauve-standard+default/' ~/.config/gtk-4.0/settings.ini
